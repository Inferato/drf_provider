...
from comments.views import CommentListCreate, CommentRetrieveUpdateDestroy
from .views import custom_token_obtaining
...
urlpatterns = [
    ...
    path('api/comments/<int:pk>/', CommentRetrieveUpdateDestroy.as_view(), name='comment-retrieve-update-destroy'),
    path('swagger/', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
    path('redoc/', schema_view.with_ui('redoc', cache_timeout=0), name='schema-redoc'),
    path('get-token', custom_token_obtaining, name='get-token')
]
